// Scale Up ×1.618 (Golden Ratio φ) — from bounding box centre of selection
...
if (!doc) { console.log('No document open'); }
    ...
    if (count === 0) {
        ...
        const scale    = Transform.createScale(PHI, PHI);
        ...
        console.log('Scaled up ×1.618 around centre (' + cx.toFixed(2) + ', ' + cy.toFixed(2) + ')');
    }
}
